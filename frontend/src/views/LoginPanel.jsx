          ...
          >
            ...
            <div className="text-center mb-7">
              <div
                ...
                style={{ color: dark ? '#0D0B61' : '#0D0B61', background: 'linear-gradient(135deg,#E4D329,#48B3AF)' }}
              >
                C
              </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between pt-1">
                ...
                <a href="#" className={`font-mono text-[11px] transition-colors ${dark ? 'text-[#476EAE] hover:text-[#48B3AF]' : 'text-[#294669] hover:text-[#48B3AF]'}`}>
