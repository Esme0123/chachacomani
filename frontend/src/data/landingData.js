...
export const PALETTE = [
  { hex: '#0D0B61', name: 'Azul Profundo', eng: 'Deep Blue' },
  { hex: '#294669', name: 'Azul Medio', eng: 'Mid Blue' },
  { hex: '#478B8D', name: 'Turquesa Medio', eng: 'Teal' },
  { hex: '#E4D329', name: 'Oro', eng: 'Gold' },
  { hex: '#476EAE', name: 'Azul Cobalto', eng: 'Cobalt' },
  { hex: '#48B3AF', name: 'Turquesa Claro', eng: 'Light Teal' },
  { hex: '#A7E399', name: 'Verde Claro', eng: 'Light Green' },
  { hex: '#F6FF99', name: 'Amarillo Claro', eng: 'Light Yellow' },
]

export const BALL_COLORS = ['#0D0B61', '#294669', '#478B8D', '#E4D329', '#476EAE', '#48B3AF', '#A7E399', '#F6FF99']