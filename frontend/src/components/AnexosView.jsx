  ...
  return (
    <div className="space-y-10 pb-16">
      ...
      <section id="anexo-I" className="space-y-6 scroll-mt-20">
        ...
        {/* Nota introductoria */}
        <div className="p-4 rounded-xl bg-slate-100 dark:bg-navy-950 border border-slate-200 dark:border-slate-800 text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
          <span className="font-bold text-slate-800 dark:text-slate-200">Disposición Transitoria (Art. 100): </span>
        ...
        <div className="bg-white dark:bg-navy-900 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden">
          <div className="px-6 py-4 bg-slate-50 dark:bg-slate-800/60 border-b border-slate-200 dark:border-slate-800 font-bold text-sm text-slate-900 dark:text-slate-100 flex items-center justify-between">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left text-xs border-collapse">
              <thead>
                <tr className="bg-slate-100/70 dark:bg-slate-800/40 text-slate-500 dark:text-slate-400 uppercase font-semibold text-[11px] border-b border-slate-200 dark:border-slate-800">
        ...
        <div className="bg-white dark:bg-navy-900 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden">
          <div className="px-6 py-4 bg-slate-50 dark:bg-slate-800/60 border-b border-slate-200 dark:border-slate-800 flex flex-wrap items-center justify-between gap-3">
            <div>
              <h3 className="font-bold text-sm text-slate-900 dark:text-slate-100">
                Cuadro N.º 2: Infracciones Específicas, Multas y Medidas Complementarias
              </h3>
              <p className="text-xs text-slate-500 mt-0.5">Arancel estandarizado para socios, directivos y personal operativo.</p>
            </div>
            ...
            <div className="flex items-center gap-1 bg-slate-200 dark:bg-slate-800 p-1 rounded-xl text-xs">
              <button
                ...
                className={`px-2.5 py-1 rounded-lg transition-all ${
                  filterCategory === 'all' ? 'bg-amber-500 text-navy-950 font-bold' : 'text-slate-600 dark:text-slate-400'
                }`}
              >
                Todas
              </button>
              <button
                ...
                className={`px-2.5 py-1 rounded-lg transition-all ${
                  filterCategory === 'Leve' ? 'bg-emerald-500 text-white font-bold' : 'text-slate-600 dark:text-slate-400'
                }`}
              >
                Leves
              </button>
              <button
                ...
                className={`px-2.5 py-1 rounded-lg transition-all ${
                  filterCategory === 'Grave' ? 'bg-amber-500 text-navy-950 font-bold' : 'text-slate-600 dark:text-slate-400'
                }`}
              >
                Graves
              </button>
              <button
                ...
                className={`px-2.5 py-1 rounded-lg transition-all ${
                  filterCategory === 'Muy grave' ? 'bg-rose-500 text-white font-bold' : 'text-slate-600 dark:text-slate-400'
                }`}
              >
                Muy Graves
              </button>
          ...
          <div className="overflow-x-auto max-h-[550px]">
            <table className="w-full text-left text-xs border-collapse">
              <thead className="sticky top-0 z-10 bg-slate-100 dark:bg-navy-950 shadow-sm">
                <tr className="text-slate-500 dark:text-slate-400 uppercase font-semibold text-[11px] border-b border-slate-200 dark:border-slate-800">
                ...
                {anexos[0]?.tablas[1]?.filas
                  ...
                  .map((fila, idx) => (
                    <tr key={idx} className="hover:bg-amber-500/5 dark:hover:bg-slate-800/40 transition-colors">
                      <td className="p-3.5 font-medium text-slate-900 dark:text-slate-100">{fila.infraccion}</td>
                      ...
                      <td className="p-3.5 text-slate-600 dark:text-slate-400">{fila.medida}</td>
                    </tr>
                  ))}
              </tbody>
            </table>
      ...
      <section id="anexo-II" className="space-y-6 pt-6 scroll-mt-20">
        ...
        <div className="p-4 rounded-xl bg-slate-100 dark:bg-navy-950 border border-slate-200 dark:border-slate-800 text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
          <span className="font-bold text-slate-800 dark:text-slate-200">Marco Operativo (Art. 13): </span>
        ...
        <div className="bg-white dark:bg-navy-900 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden">
          <div className="px-6 py-4 bg-slate-50 dark:bg-slate-800/60 border-b border-slate-200 dark:border-slate-800 font-bold text-sm text-slate-900 dark:text-slate-100">
              ...
              <tbody className="divide-y divide-slate-100 dark:divide-slate-800 text-slate-700 dark:text-slate-300">
                {anexos[1]?.tablas[0]?.filas.map((item, idx) => (
                  <tr key={idx} className="hover:bg-slate-50 dark:hover:bg-slate-800/30 transition-colors">
                    <td className="p-3.5 font-semibold text-slate-900 dark:text-slate-100">{item.concepto}</td>
                    <td className="p-3.5 text-slate-600 dark:text-slate-400">{item.periodicidad}</td>
